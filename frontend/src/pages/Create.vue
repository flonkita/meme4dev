      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="info-section">
            ...
            <p class="info-text">
              Bienvenue sur la page de création de mèmes! Ici, vous pouvez créer
              vos propres mèmes en téléchargeant une image de modèle et en y
              ajoutant du texte personnalisé. Utilisez les contrôles ci-dessous
              pour commencer.
            </p>
          </div>
        </div>
        <div class="col-md-8 col-lg-6 meme-preview-container">
          <div class="meme-preview">
            ...
            <div
              ...
              :key="index"
              :style="{ top: text.top, left: text.left, color: text.color }"
            >
              {{ text.content }}
            </div>
          </div>
        ...
        <div class="col-md-8 col-lg-6 controls">
          ...
          <div class="text-controls">
            ...
            >
              ...
              />
              <button class="btn btn-danger" @click="removeText(index)">
                Retirer
              </button>
            </div>
            <button class="btn btn-secondary" @click="addText">
              Ajouter le texte
            </button>
          </div>
          <div class="action-buttons">
            <button class="btn btn-success" @click="createMeme">
              Créer le meme
            </button>
  ...
  methods: {
    ...
    async createMeme() {
      ...
      this.texts.forEach((text, index) => {
        formData.append(`textTop${index}`, text.content);
      });
      ...
      try {
        ...
        alert("Meme créé avec succès!");
        this.resetForm();
      } catch (error) {
        console.error(error);
        alert("Erreur lors de la création du mème.");
      }
    },
    resetForm() {
